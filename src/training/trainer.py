...
class LightningTrainer:
    ...
    def __init__(
        ...
        self.saved_models_dir = REPO_ROOT / 'saved_models'
    ...
    def save_model(self, model: pl.LightningModule):
        ...
        if self.early_stopping_callback:
            config['training'].update({
                ...
                'early_stopping_patience': getattr(self.early_stopping_callback, 'patience', None),
                'early_stopping_monitor': getattr(self.early_stopping_callback, 'monitor', None),
                'early_stopping_mode': getattr(self.early_stopping_callback, 'mode', None)
            })
