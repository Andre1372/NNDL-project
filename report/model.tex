...
This GAN network is composed by a Res-CNN Generator, which containts the same Conditioner and convolutional layers as in MindiNet, but with a sequence of Residual blocks
