...
\title{PIANOGAN: A GENERATOR-CRITIC APPROACH FOR SYMBOLIC-DOMAIN MUSIC GENERATION}
...
\begin{IEEEkeywords}
Neural Networks, Convolutional Neural Networks, Generative Adversarial Networks, Symbolic-Domain Music, Wasserstein distance, Residual blocks
\end{IEEEkeywords}
