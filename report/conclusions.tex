...
What we realised by designing this network is that it is difficult to understand how the different blocks interact with each other and hence how to improve the model: each block we added or removed eventually led to a very differente behaviour of the network, which was not always easy to predict.
